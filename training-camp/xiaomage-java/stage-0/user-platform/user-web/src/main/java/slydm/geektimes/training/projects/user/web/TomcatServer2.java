...
// */
//public class TomcatServer2 implements Server {
//
...
//
//    Path path = Paths.get(base).getParent().getParent().toAbsolutePath();
//    System.out.println(path.toString());
//
//    Context context = tomcat.addWebapp(DEFAULT_CONTEXT_PATH, path.toString());
//
